      ...
      $(".knob").knob({
        ...
        draw: function () {
          if (this.$.data("skin") == "tron") {
            ...
            this.o.cursor && (sat = eat - .3) && (eat = eat + .3);
            if (this.o.displayPrevious) {
              ea = this.startAngle + this.angle(this.v);
              this.o.cursor && (sa = ea - .3) && (ea = ea + .3);
              this.g.beginPath();
...
function sidebar_menu_item_expand($li, $sub) {
  ...
  interval_1 = setTimeout(function () {
    ...
    if (t_duration && t_delay) {
      finish_on = (t_duration + t_delay) * 1e3
    }
...
function date(format, timestamp) {
  ...
  this.date = function (format, timestamp) {
    that = this;
    jsdate = timestamp === undefined ? new Date : timestamp instanceof Date ? new Date(timestamp) : new Date(timestamp * 1e3);
